...
const Home = () => {
  return (
    <>
      ...
      >
        <div className="w-1/2">
          <h2 className="font-medium text-3xl font-merri-sans text-slate-900 mb-8">
            Sobre Nós
          </h2>
          ...
          <p className="mb-8 text-justify">
            ...
            <strong className="text-slate-900"> DENÚNCIAS </strong> no qual você
          ...
          <h2 className="text-slate-900 text-2xl font-medium mb-8">
